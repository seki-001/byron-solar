  ...
  return (
    <main className="page-top glass-grid-bg min-h-screen">
      <div className="container-max px-4 sm:px-6 lg:px-8 pb-4">
        <div className="glass-panel-light rounded-3xl py-5 px-6 sm:px-8 mb-6">
      ...
      <div className="container-max px-4 sm:px-6 lg:px-8 py-4 pb-10 max-w-3xl">
        <div className="glass-card rounded-2xl p-8 space-y-8">
          ...
          {[
            ...
            { title: '3. Data Storage', body: 'Your data is stored securely and retained for up to 3 years. You may request deletion at any time by emailing info@arcnad.co.ke.' },
            { title: '4. Cookies', body: 'We use only essential cookies for functionality. No tracking or advertising cookies are used.' },
            { title: '5. Your Rights', body: 'You have the right to access, correct, or delete your personal data. Contact us at info@arcnad.co.ke.' },
          ].map((s) => (
            <section key={s.title}>
        ...
        <div id="terms" className="glass-card rounded-2xl p-8 mt-6 space-y-8">
          <div>
          ...
          {[
            { title: '1. Acceptance of Terms', body: 'By using arcnad.co.ke, you accept these Terms of Service. If you do not agree, please do not use this website.' },
