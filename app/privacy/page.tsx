...
export const metadata: Metadata = {
  title: 'Privacy Policy & Terms | SolarCo Kenya',
  description: 'Privacy Policy and Terms of Service for SolarCo Kenya.',
}
      ...
      <div className="container-max px-4 sm:px-6 lg:px-8 py-8 max-w-3xl">
        <div className="bg-white border border-ui-border rounded-card p-8 space-y-8">
          ...
          {[
            ...
            { title: '3. Data Storage', body: 'Your data is stored securely and retained for up to 3 years. You may request deletion at any time by emailing info@solarco.co.ke.' },
            { title: '4. Cookies', body: 'We use only essential cookies for functionality. No tracking or advertising cookies are used.' },
            { title: '5. Your Rights', body: 'You have the right to access, correct, or delete your personal data. Contact us at info@solarco.co.ke.' },
          ].map((s) => (
            <section key={s.title}>
        ...
        <div id="terms" className="bg-white border border-ui-border rounded-card p-8 mt-6 space-y-8">
          ...
          {[
            { title: '1. Acceptance of Terms', body: 'By using solarco.co.ke, you accept these Terms of Service. If you do not agree, please do not use this website.' },
            ...
            { title: '4. Limitation of Liability', body: "SolarCo shall not be liable for indirect, incidental, or consequential damages. Our liability is limited to the maximum extent permitted by Kenyan law." },
