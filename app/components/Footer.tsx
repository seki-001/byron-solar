...
export default function Footer() {
  return (
    <footer className="bg-brand-navy text-white glass-grid-footer mt-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-10">
          ...
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 mt-4 bg-[#25D366] text-white px-3 py-1.5 rounded-full text-xs font-semibold hover:bg-[#1db954] transition-colors"
            >
