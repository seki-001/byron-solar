    ...
    <section className="page-top">
      <div className="container-max px-4 sm:px-6 lg:px-8 pb-6">
        <div className="glass-panel-light rounded-3xl overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0 items-center min-h-[420px]">
            <div className="py-8 px-6 sm:px-8 md:pr-6">
              <motion.div
            ...
            <motion.div
              className="relative h-[320px] md:h-[420px] flex items-center justify-center bg-gradient-to-br from-brand-cyan/40 via-brand-lavender/30 to-transparent"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              ...
              <div className="absolute top-4 right-4 glass-badge-light text-xs font-semibold">
                ⚡ Zero electricity bills
              </div>
              <div className="absolute bottom-4 left-4 glass-panel-brand rounded-2xl px-3 py-2 text-xs font-semibold text-brand-navy">
                ✓ 5-Year Warranty
              </div>
            </motion.div>
          </div>
